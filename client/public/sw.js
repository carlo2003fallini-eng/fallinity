...
const buildVersion = new URL(self.location.href).searchParams.get("v") || "fase-59-analisi-direzione-dashboard";
...
const APP_SHELL = [
  ...
  "/manus-storage/fallinity-app-icon-192_3ee5c98d.png",
  ...
  "/manus-storage/finance-manual-entry_50e37e4c.png",
  "/manus-storage/finance-ai-entry_833a1992.png",
];
